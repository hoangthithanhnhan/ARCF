...
const HeroBanner = ({ title, description, actions = [], backgroundImage, videoEmbedUrl }: HeroBannerProps) => {
    return (
        <section className='grid grid-cols-1 sm:grid-cols-2 bg-cover bg-center bg-no-repeat text-white' style={{ backgroundImage: "url('/images/BackgroundBanner.png')" }}>
            <div className='w-full text-center px-15 py-15 pb-0 sm:py-15 sm:pr-5 sm:pl-15 xl:pt-25.5 xl:pl-35 xl:pb-37 xl:pr-10 sm:text-left'>
            ...
            {backgroundImage ? 
                ...
                <div className="w-full h-100 sm:h-full flex p-10 xl:pt-14 xl:pr-35 xl:pb-22.75">
                    <iframe src={videoEmbedUrl} title="Video" className="w-full h-full max-h-[400px] rounded-lg" frameBorder="0" allowFullScreen/>
                </div>
            }
        </section>
        )
