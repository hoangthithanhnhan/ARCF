...
const HeroBanner = ({ title, description, actions = [], backgroundImage, videoEmbedUrl }: HeroBannerProps) => {
    return (
        <section className='grid grid-cols-1 items-center md:grid-cols-2 bg-cover bg-center bg-no-repeat text-white' style={{ backgroundImage: "url('/images/BackgroundBanner.png')" }}>
            <div className='w-full text-center p-10 pb-0 md:py-15 md:pr-5 md:pl-15 xl:pt-25.5 xl:pl-35 xl:pb-37 xl:pr-10 md:text-left'>
